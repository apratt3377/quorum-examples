...
geth --datadir qdata/dd1 init $consensus-genesis.json
...
geth --datadir qdata/dd2 init $consensus-genesis.json
...
geth --datadir qdata/dd3 init $consensus-genesis.json
...
geth --datadir qdata/dd4 init $consensus-genesis.json
...
geth --datadir qdata/dd5 init $consensus-genesis.json
...
geth --datadir qdata/dd6 init $consensus-genesis.json
...
geth --datadir qdata/dd7 init $consensus-genesis.json
